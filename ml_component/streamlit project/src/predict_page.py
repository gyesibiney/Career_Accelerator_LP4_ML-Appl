...
# data loading
model_path=r"C:\Users\DAVID\Career_Accelerator_LP4_ML-Appl\ml_component\saved_ml.joblib"
...
<<<<<<<< HEAD:ml_component/streamlit project/src/predict_page.py
...
========
    ...
    st.success (f'the estimated forecast sales ${output.values[0]:.2f}')
>>>>>>>> 88abd2fb4c43a5820130a0fd8b5b42aa6c2c70af:src/predict_page.py
=======
import streamlit as st
from datetime import date
import numpy as np
...
if ok:
    ...
    output_values=forecast['yhat']
    st.success (f'the estimated forecast sales ${output_values.values[0]:.2f}')
>>>>>>> 88abd2fb4c43a5820130a0fd8b5b42aa6c2c70af
